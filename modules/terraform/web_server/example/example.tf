...
module "web" {
  ...
  virtual_machine_suffix                                    = ["-testweb"]
  ...
  sql_aliases                      = [{ "target" = "10.0.0.3,1433", "name" = ["EnvironmentLookup"] }]
  hosts_entries                    = [{ "name" = "login.test.com", "ip" = "127.0.0.1" }]
  dns_records                      = [{ "name" = "login", "zone" = "test.com", "ip" = cidrhost(azurerm_subnet.dmz.address_prefixes[0], 50) }]
...
output "lb_ip_address" {
  value = module.web.lb_ip_address
}

output "name_with_ip_address" {
  value = module.web.name_with_ip_address
}

output "fqdn_with_ip_address" {
  value = module.web.fqdn_with_ip_address
}
