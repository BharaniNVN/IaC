...
variable "service_account_username" {
  description = "Username of the custom service RunAs account which would be used to grant necessary permissions."
  default     = "NT AUTHORITY\\\\SYSTEM"
}

variable "service_account_password" {
  description = "Password of the custom service RunAs account which would be used to grant necessary permissions."
  default     = "5up3rp@%%w0rd"
}

variable "firewall_ports" {
  description = "List of the ports which should be opened in Windows Firewall. In case variable is empty and loadbalancer is deployed with some rules - port numbers will be fetched from them."
  default     = []
  type        = list(number)
}
...
variable "storage_share" {
  description = "File share fully qualified domain name."
  default     = null
  type        = string
}

variable "storage_share_access_username" {
  description = "Username for account used to access UNC share."
  default     = "b3shareadmin"
}

variable "storage_share_access_password" {
  description = "Password for account used to access UNC share."
  default     = "5up3rp@%%w0rd"
}
