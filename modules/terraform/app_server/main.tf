  ...
  settings = <<SETTINGS
    {
      ...
      "configurationArguments": {
        ...
        "FileShares": ${jsonencode(var.file_shares)},
        ...
        "ServiceRunAsAccounts": ${jsonencode(var.service_accounts)},
        "EnableSSIS": ${var.enable_ssis},
        "SQLInstanceName": "${var.sql_instance_name}",
        "EnableSQLDeveloper": ${var.enable_sql_developer},
        "EnableOracleTools": ${var.enable_oracle_tools},
