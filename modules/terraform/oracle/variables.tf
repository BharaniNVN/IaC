...
variable "oracle_service_pswd" {
  ...
  default     = "$trong_p@SSw0rd@%^"
}

variable "oracle_sys_pswd" {
  description = "Password to be used for all system databases: SYS, SYSTEM and DBSNMP"
  default     = "@noth3r_$trong_p@SSw0rd@%^"
}

variable "oracle_global_db_name" {
  description = "To be used for Starter Database Global Database Name and SID"
  default     = "orcl"
}
