  ...
  settings = <<SETTINGS
    {
      ...
      "configurationArguments": {
        ...
        "BatchJobRunAsAccounts": ${jsonencode(var.batch_job_accounts)},
        "Disks": ${jsonencode(var.data_disk)},
        "FirewallPorts": ${jsonencode(local.firewall_ports)},
        "OracleGlobalDBName": "${var.oracle_global_db_name}",
        "OracleInstallFiles": ${jsonencode(var.oracle_install_files)},
        "OracleProductName": "${var.oracle_product_name}",
        "OracleProductVersion": "${var.oracle_product_version}",
  ...
  protected_settings = <<PROTECTEDSETTINGS
    {
      ...
      "configurationArguments": {
        ...
        "OracleServiceRunAsCredential": {
          "UserName": "${var.oracle_service_user}",
          "Password": "${var.oracle_service_pswd}"
        },
        "OracleDBCredential": {
          "UserName": "PLACEHOLDER_DO_NOT_USE",
          "Password": "${var.oracle_sys_pswd}"
        },
