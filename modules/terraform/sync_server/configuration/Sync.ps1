Configuration Sync {
    ...
    Node $NodeName {
        ...
        'NET-Framework-Core', 'NET-Framework-45-Core', 'NET-Framework-45-ASPNET', 'NET-WCF-TCP-PortSharing45' | % {
        ...
        'Web-Http-Redirect', 'Web-DAV-Publishing', 'Web-Http-Logging', 'Web-Custom-Logging', `
        'Web-Log-Libraries', 'Web-ODBC-Logging', 'Web-Request-Monitor', 'Web-Http-Tracing', `
        'Web-Stat-Compression', 'Web-Dyn-Compression', 'Web-Filtering', 'Web-Basic-Auth', `
        'Web-CertProvider', 'Web-Client-Auth', 'Web-Digest-Auth', 'Web-Cert-Auth', 'Web-IP-Security', `
        'Web-Url-Auth', 'Web-Windows-Auth', 'Web-Net-Ext', 'Web-Net-Ext45', 'Web-AppInit', `
        'Web-ASP', 'Web-Asp-Net', 'Web-Asp-Net45', 'Web-CGI', 'Web-ISAPI-Ext', 'Web-ISAPI-Filter', `
        'Web-Includes', 'Web-WebSockets', 'Web-Mgmt-Console', 'Web-Scripting-Tools' | % {
