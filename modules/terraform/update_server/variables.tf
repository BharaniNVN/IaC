...
variable "upstream_server_name" {
  description = "Name of the upstream WSUS server to synchronize information and/or content from."
  default     = ""
}

variable "upstream_server_port" {
  description = "Port of the upstream WSUS server."
  default     = 8530
}

variable "install_adconnect" {
  description = "Whether to install AD Connect application or not."
  default     = false
}
