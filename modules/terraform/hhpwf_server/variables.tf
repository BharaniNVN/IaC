...
variable "app_pool_account" {
  description = "Part of SID of the custom application pool account which would be used to grant necessary permissions on specified lists of folders. S-1-5-17 equals IUSR service account."
  default     = "S-1-5-17"
}
...
variable "certificate_subjects" {
  description = "List of certificates subjects which should be read by application pool account."
  default     = []
  type        = list(string)
}
