...
function Get-TargetResource
{
    ...
    if ($null -ne $service)
    {
        ...
        $builtInAccount = switch ($serviceCimInstance.StartName)
        {
            ...
            'NT Authority\System' { 'System'; break }
...
function Set-TargetResource
{
    ...
    (
        ...
        [Parameter()]
        [ValidateSet('LocalSystem', 'LocalService', 'NetworkService', 'System')]
        [System.String]
        $BuiltInAccount,
    ...
    else
    {
        ...
        if ($setServicePropertyParameters.Count -gt 0)
        {
            ...
            $serviceRestartNeeded = Set-ServiceProperty -ServiceName $Name @setServicePropertyParameters
        }
...
function ConvertTo-StartName
{
    ...
    if ($Username -ieq 'NetworkService' -or $Username -ieq 'LocalService' -or $Username -ieq 'System')
    {
...
<#
    .SYNOPSIS
        ...
        (StartName, StartPassword, DesktopInteract). Returns a boolean specifying whether
...
function Set-ServiceProperty
{
    ...
    {
        $restartNeeded = Set-ServiceAccountProperty -ServiceName $ServiceName @setServiceAccountPropertyParameters
    }
