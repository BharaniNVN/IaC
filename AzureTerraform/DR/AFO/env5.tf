resource "azurerm_resource_group" "env5" {
  name     = "${local.prefix}-env5-rg"
  location = var.location

  tags = merge(
    local.tags,
    {
      "logicalEnvironment" = "DR5"
...
module "afo5" {
  ...
  resource_group_resource                 = azurerm_resource_group.env5
  resource_prefix                         = local.prefix
  virtual_machine_suffix                  = ["-afoaz51", "-afoaz52"]
  availability_set_suffix                 = "-afoaz5-av"
  boot_diagnostics_storage_account_suffix = "afoaz5mxhhpdiag"
  subnet_resource                         = local.dmz_subnet
  dns_servers                             = local.dmz_domain["dns_servers"]
  vm_starting_ip                          = var.afo5_vm_starting_ip
  ...
  azure_devops_agent_tags                 = "AFO, DR5"
...
module "app5" {
  ...
  resource_group_resource                 = azurerm_resource_group.env5
  resource_prefix                         = local.prefix
  virtual_machine_suffix                  = ["-appaz51"]
  availability_set_suffix                 = "-appaz5-av"
  boot_diagnostics_storage_account_suffix = "appaz5mxhhpdiag"
  ...
  azure_devops_project                    = var.azure_devops_project
  azure_devops_deployment_group           = "US-Azure-NorthCentral-US-DR"
  azure_devops_agent_tags                 = "APP, DR5"
  azure_devops_pat_token                  = var.azure_devops_pat_token
  dependency_agent_extension_version      = var.dependency_agent_extension_version
  microsoft_antimalware_extension_version = var.microsoft_antimalware_extension_version
...
module "sql5" {
  ...
  resource_group_resource                 = azurerm_resource_group.env5
  resource_prefix                         = local.prefix
  virtual_machine_suffix                  = ["-sqlaz51"]
  availability_set_suffix                 = "-sqlaz5-av"
  boot_diagnostics_storage_account_suffix = "sqlaz5mxhhpdiag"
  subnet_resource                         = local.internal_subnet
  dns_servers                             = local.internal_domain["dns_servers"]
  vm_starting_ip                          = 74
  vm_size                                 = "Standard_E32s_v3"
  data_disk = [
    { "name" = "db", "type" = "Premium_LRS", "size" = 3200, "lun" = 0, "caching" = "ReadOnly" },
  ...
  azure_devops_project                    = var.azure_devops_project
  azure_devops_deployment_group           = "US-Azure-NorthCentral-US-DR"
  azure_devops_agent_tags                 = "DB, MsSql, Clinical, DR5"
  azure_devops_pat_token                  = var.azure_devops_pat_token
  dependency_agent_extension_version      = var.dependency_agent_extension_version
  microsoft_antimalware_extension_version = var.microsoft_antimalware_extension_version
...
module "oracle5" {
  ...
  resource_group_resource                 = azurerm_resource_group.env5
  resource_prefix                         = local.prefix
  virtual_machine_suffix                  = ["-oraaz51"]
  availability_set_suffix                 = "-oraaz5-av"
  boot_diagnostics_storage_account_suffix = "oraaz5mxhhpdiag"
  subnet_resource                         = local.internal_subnet
  dns_servers                             = local.internal_domain["dns_servers"]
  vm_starting_ip                          = 94
  vm_size                                 = "Standard_E32s_v3"
  ...
  azure_devops_project                    = var.azure_devops_project
  azure_devops_deployment_group           = "US-Azure-NorthCentral-US-DR"
  azure_devops_agent_tags                 = "DB, Oracle, DR5"
  azure_devops_pat_token                  = var.azure_devops_pat_token
  dependency_agent_extension_version      = var.dependency_agent_extension_version
  microsoft_antimalware_extension_version = var.microsoft_antimalware_extension_version
