resource "azurerm_resource_group" "env6" {
  name     = "${local.prefix}-env6-rg"
  location = var.location

  tags = merge(
    local.tags,
    {
      "logicalEnvironment" = "DR6"
...
module "afo6" {
  ...
  resource_group_resource                 = azurerm_resource_group.env6
  resource_prefix                         = local.prefix
  virtual_machine_suffix                  = ["-afoaz61", "-afoaz62"]
  availability_set_suffix                 = "-afoaz6-av"
  boot_diagnostics_storage_account_suffix = "afoaz6mxhhpdiag"
  subnet_resource                         = local.dmz_subnet
  dns_servers                             = local.dmz_domain["dns_servers"]
  vm_starting_ip                          = var.afo6_vm_starting_ip
  ...
  azure_devops_agent_tags                 = "AFO, DR6"
...
module "app6" {
  ...
  resource_group_resource                 = azurerm_resource_group.env6
  resource_prefix                         = local.prefix
  virtual_machine_suffix                  = ["-appaz61"]
  availability_set_suffix                 = "-appaz6-av"
  boot_diagnostics_storage_account_suffix = "appaz6mxhhpdiag"
  ...
  azure_devops_project                    = var.azure_devops_project
  azure_devops_deployment_group           = "US-Azure-NorthCentral-US-DR"
  azure_devops_agent_tags                 = "APP, DR6"
  azure_devops_pat_token                  = var.azure_devops_pat_token
  dependency_agent_extension_version      = var.dependency_agent_extension_version
  microsoft_antimalware_extension_version = var.microsoft_antimalware_extension_version
...
module "sql6" {
  ...
  resource_group_resource                 = azurerm_resource_group.env6
  resource_prefix                         = local.prefix
  virtual_machine_suffix                  = ["-sqlaz61"]
  availability_set_suffix                 = "-sqlaz6-av"
  boot_diagnostics_storage_account_suffix = "sqlaz6mxhhpdiag"
  subnet_resource                         = local.internal_subnet
  dns_servers                             = local.internal_domain["dns_servers"]
  vm_starting_ip                          = 76
  vm_size                                 = "Standard_E32s_v3"
  data_disk = [
    { "name" = "db", "type" = "Premium_LRS", "size" = 4000, "lun" = 0, "caching" = "ReadOnly" },
  ...
  azure_devops_project                    = var.azure_devops_project
  azure_devops_deployment_group           = "US-Azure-NorthCentral-US-DR"
  azure_devops_agent_tags                 = "DB, MsSql, Clinical, DR6"
  azure_devops_pat_token                  = var.azure_devops_pat_token
  dependency_agent_extension_version      = var.dependency_agent_extension_version
  microsoft_antimalware_extension_version = var.microsoft_antimalware_extension_version
...
module "oracle6" {
  ...
  resource_group_resource                 = azurerm_resource_group.env6
  resource_prefix                         = local.prefix
  virtual_machine_suffix                  = ["-oraaz61"]
  availability_set_suffix                 = "-oraaz6-av"
  boot_diagnostics_storage_account_suffix = "oraaz6mxhhpdiag"
  subnet_resource                         = local.internal_subnet
  dns_servers                             = local.internal_domain["dns_servers"]
  vm_starting_ip                          = 96
  vm_size                                 = "Standard_E32s_v3"
  ...
  azure_devops_project                    = var.azure_devops_project
  azure_devops_deployment_group           = "US-Azure-NorthCentral-US-DR"
  azure_devops_agent_tags                 = "DB, Oracle, DR6"
  azure_devops_pat_token                  = var.azure_devops_pat_token
  dependency_agent_extension_version      = var.dependency_agent_extension_version
  microsoft_antimalware_extension_version = var.microsoft_antimalware_extension_version
