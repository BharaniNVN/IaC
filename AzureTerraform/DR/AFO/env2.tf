resource "azurerm_resource_group" "env2" {
  name     = "${local.prefix}-env2-rg"
  location = var.location

  tags = merge(
    local.tags,
    {
      "logicalEnvironment" = "DR2"
...
module "afo2" {
  ...
  resource_group_resource                 = azurerm_resource_group.env2
  resource_prefix                         = local.prefix
  virtual_machine_suffix                  = ["-afoaz21", "-afoaz22"]
  availability_set_suffix                 = "-afoaz2-av"
  boot_diagnostics_storage_account_suffix = "afoaz2mxhhpdiag"
  subnet_resource                         = local.dmz_subnet
  dns_servers                             = local.dmz_domain["dns_servers"]
  vm_starting_ip                          = var.afo2_vm_starting_ip
  ...
  azure_devops_agent_tags                 = "AFO, DR2"
...
module "app2" {
  ...
  resource_group_resource                 = azurerm_resource_group.env2
  resource_prefix                         = local.prefix
  virtual_machine_suffix                  = ["-appaz21"]
  availability_set_suffix                 = "-appaz2-av"
  boot_diagnostics_storage_account_suffix = "appaz2mxhhpdiag"
  ...
  azure_devops_project                    = var.azure_devops_project
  azure_devops_deployment_group           = "US-Azure-NorthCentral-US-DR"
  azure_devops_agent_tags                 = "APP, DR2"
  azure_devops_pat_token                  = var.azure_devops_pat_token
  dependency_agent_extension_version      = var.dependency_agent_extension_version
  microsoft_antimalware_extension_version = var.microsoft_antimalware_extension_version
...
module "sql2" {
  ...
  resource_group_resource                 = azurerm_resource_group.env2
  resource_prefix                         = local.prefix
  virtual_machine_suffix                  = ["-sqlaz21"]
  availability_set_suffix                 = "-sqlaz2-av"
  boot_diagnostics_storage_account_suffix = "sqlaz2mxhhpdiag"
  subnet_resource                         = local.internal_subnet
  dns_servers                             = local.internal_domain["dns_servers"]
  vm_starting_ip                          = 70
  vm_size                                 = "Standard_E32s_v3"
  data_disk = [
    { "name" = "db", "type" = "Premium_LRS", "size" = 7600, "lun" = 0, "caching" = "None" },
    { "name" = "logs", "type" = "Standard_LRS", "size" = 300, "lun" = 1, "caching" = "None" },
  ...
  azure_devops_project                    = var.azure_devops_project
  azure_devops_deployment_group           = "US-Azure-NorthCentral-US-DR"
  azure_devops_agent_tags                 = "DB, MsSql, Clinical, DR2"
  azure_devops_pat_token                  = var.azure_devops_pat_token
  dependency_agent_extension_version      = var.dependency_agent_extension_version
  microsoft_antimalware_extension_version = var.microsoft_antimalware_extension_version
...
module "oracle2" {
  ...
  resource_group_resource                 = azurerm_resource_group.env2
  resource_prefix                         = local.prefix
  virtual_machine_suffix                  = ["-oraaz21"]
  availability_set_suffix                 = "-oraaz2-av"
  boot_diagnostics_storage_account_suffix = "oraaz2mxhhpdiag"
  subnet_resource                         = local.internal_subnet
  dns_servers                             = local.internal_domain["dns_servers"]
  vm_starting_ip                          = 90
  vm_size                                 = "Standard_E32s_v3"
  ...
  azure_devops_project                    = var.azure_devops_project
  azure_devops_deployment_group           = "US-Azure-NorthCentral-US-DR"
  azure_devops_agent_tags                 = "DB, Oracle, DR2"
  azure_devops_pat_token                  = var.azure_devops_pat_token
  dependency_agent_extension_version      = var.dependency_agent_extension_version
  microsoft_antimalware_extension_version = var.microsoft_antimalware_extension_version
