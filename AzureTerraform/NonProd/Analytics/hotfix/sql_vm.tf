module "sql" {
  ...
  virtual_machine_suffix                  = ["hfsqlaze2int01"]
  ...
  boot_diagnostics_storage_account_suffix = "hotfixanabootsql"
  vm_starting_ip                          = 5
  vm_size                                 = "Standard_E4s_v3"
  os_managed_disk_type                    = "Standard_LRS"
  data_disk = [
    { "name" = "db", "type" = "Standard_LRS", "size" = 500, "lun" = 0, "caching" = "None" },
    { "name" = "logs", "type" = "Standard_LRS", "size" = 500, "lun" = 1, "caching" = "None" },
    { "name" = "temp", "type" = "Standard_LRS", "size" = 500, "lun" = 2, "caching" = "None" },
