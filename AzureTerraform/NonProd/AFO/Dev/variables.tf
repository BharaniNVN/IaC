...
variable "nondbservers_local_administrators" {
  description = "List of domain users/groups which should be part of Local Administrators group on non DB related servers, e.g. except SQL/Oracle."
...
variable "azure_devops_deployment_group" {
  ...
  default     = "US-Azure-EastUs2-AfoDev-NonProd"
}
