...
resource "azurerm_key_vault" "codingcenter_shared" {
  name                            = "${local.deprecated_prefix}-kv"
...
resource "azurerm_key_vault_access_policy" "terraform" {
  key_vault_id = azurerm_key_vault.codingcenter_shared.id
  tenant_id    = data.azurerm_client_config.current.tenant_id
...
resource "azurerm_monitor_diagnostic_setting" "key_vault" {
  ...
  target_resource_id         = azurerm_key_vault.codingcenter_shared.id
