...
variable "internal_domain_join_user" {
  description = "Account with Domain Join privilege level to join a new server to the CAWPROD domain."
  default     = "InternalDomainJoinUser"
}

variable "internal_domain_join_pswd" {
...
variable "ir_name" {
  description = "Name of the Integration Runtime to be created on ADF"
...
variable "deployment_agent_user" {
  ...
  default     = "CAWPROD\\\\deploymentagent"
}
