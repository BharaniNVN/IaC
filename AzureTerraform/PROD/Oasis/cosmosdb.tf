resource "azurerm_cosmosdb_account" "this" {
  name                = "${local.deprecated_prefix}-cdba"
  ...
  ip_range_filter = format("%s,%s,%s", azurerm_windows_web_app.this.possible_outbound_ip_addresses, join(",", values(data.terraform_remote_state.prod_shared.outputs.office_public_ip_address)), "104.42.195.92,40.76.54.131,52.176.6.30,52.169.50.45,52.187.184.26")
