locals {
  ...
  secrets = {
    "ACRAppClientId"               = azuread_service_principal.container_registry.application_id
    "ACRAppClientSecret"           = azuread_service_principal_password.container_registry.value
